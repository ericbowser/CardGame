...
describe('Card counter — bankroll goal $3000', () => {
    beforeEach(() => {
        cy.visit('/');
    ...
    it('plays Hi-Lo basic strategy with a bet spread until $3000 or bust', () => {
        ...
        cy.get('[data-testid="player-chips"]').should(($el) => {
            ...
            expect(chips, 'bankroll reached $3000').to.be.at.least(GOAL_TARGET_DOUBLE);
        });
    });
});
