    ...
    return (
        <div className="text-gray-700">
            <button
                ...
                className="bg-black hover:bg-gray-800 px-4 py-3 rounded-xl font-bold flex items-center text-white shadow-card transform hover:scale-105 transition-all duration-200 w-full justify-center"
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-card-lg max-w-3xl w-full max-h-screen overflow-y-auto border-2 border-gray-200">
                        <div className="p-8">
                            ...
                            <div className="space-y-6 text-gray-700">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <ol className="space-y-2 list-none">
                                        <li className="flex items-start">
                                            <span className="bg-gray-200 text-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">1</span>
                                            <span>Click "Deal Cards" to start a new round and receive your initial two cards.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="bg-gray-200 text-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">2</span>
                                            <span>You and the dealer will each receive two cards initially.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="bg-gray-200 text-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">3</span>
                                        ...
                                        <li className="flex items-start">
                                            <span className="bg-gray-200 text-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">7</span>
                                ...
                                <div className="bg-gray-100 rounded-xl p-6 border border-gray-300">
                                    ...
                                    <ul className="space-y-3 list-none">
                                        <li className="flex items-start">
                                            ...
                                            <div>
                                                <strong className="text-gray-800">Blackjack:</strong> If your first two cards are an Ace and a 10-value card,
                                        ...
                                        <li className="flex items-start">
                                            <span className="text-gray-500 text-xl mr-3">🤖</span>
                                            <div>
                                                <strong className="text-gray-800">Dealer Rules:</strong> The dealer must hit on 16 or less and stand on 17 or more.
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <ul className="space-y-2 list-none">
                                            <li className="flex items-center">
                                                <span className="bg-gray-200 text-gray-700 rounded-lg px-3 py-1 text-sm font-bold mr-3">2-10</span>
                                                <span>Face value (2 = 2 points, 10 = 10 points)</span>
                                            </li>
                                            <li className="flex items-center">
                                                <span className="bg-gray-200 text-gray-700 rounded-lg px-3 py-1 text-sm font-bold mr-3">J Q K</span>
                                                <span>10 points each</span>
                                            </li>
                                        </ul>
                                        <ul className="space-y-2 list-none">
                                            <li className="flex items-center">
                                                <span className="bg-gray-300 text-gray-700 rounded-lg px-3 py-1 text-sm font-bold mr-3">ACE</span>
                                ...
                                <div className="text-center pt-4">
                                    <button
                                        onClick={() => setIsOpen(false)}
                                        className="bg-black hover:bg-gray-800 px-8 py-3 rounded-xl text-white font-bold shadow-card transform hover:scale-105 transition-all duration-200"
                                    >
                                        🎴 Got it! Let's Play
                                    </button>
                                </div>
