            ...
            <div className="flex items-end justify-between gap-3">
                ...
                <div className="text-right">
                    ...
                    <div className={`text-xl font-bold tabular-nums ${pnlTone}`} data-testid="last-hand-pnl">
                        {lastRoundPnL == null
                            ? '—'
                            : `${lastRoundPnL > 0 ? '+' : lastRoundPnL < 0 ? '-' : ''}$${Math.abs(lastRoundPnL)}`}
                    </div>
                </div>
            </div>
            ...
            {isDeckShuffled && (
                <div className="grid grid-cols-2 gap-2 border-t border-white/10 pt-3">
                    ...
                    <div className="rounded-lg border border-white/10 bg-black/35 px-2 py-2">
                        ...
                        <div
                            className={`text-lg font-extrabold tabular-nums ${evValueClass(evPercent)}`}
                            data-testid="ev-percent"
                        >
                    ...
                    <div className="rounded-lg border border-white/10 bg-black/35 px-2 py-2">
                        ...
                        <div
                            className="text-lg font-extrabold tabular-nums text-amber-200"
                            data-testid="suggested-bet"
                        >
                            ${suggestedBet}
